...
const items = [
  ...
  { title: "Malls", desc: "Crowd management, asset protection and hygiene at scale.", img: "/images/guard-visitor-control.png", points: ["Crowd & queue", "Lost-and-found liaison", "Emergency drills"] },
