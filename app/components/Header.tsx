...
export default function Header() {
  ...
  return (
    <>
      ...
      <div className="hidden lg:block bg-[#070F1F] text-white text-[11px] tracking-[0.18em] uppercase">
        <div className="max-w-[1280px] mx-auto px-6 py-2.5 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <a href="tel:9136645289" className="flex items-center gap-2 hover:text-[#C5A253] transition min-h-[28px] touch-manipulation">
      ...
      {/* Main header */}
      <header className={`mobile-fixed-header fixed inset-x-0 top-0 z-[100] border-b transition-all duration-300 lg:sticky lg:inset-x-auto lg:z-50 ${scrolled ? "bg-[#0A1931]/95 nav-blur border-white/10 shadow-[0_8px_32px_rgba(0,0,0,0.3)]" : "bg-[#0A1931] border-white/5"}`}>
        <div className="max-w-[1280px] mx-auto px-3 sm:px-4 lg:px-6 flex items-center justify-between h-[60px] sm:h-[64px] lg:h-[76px]">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <a href="tel:9136645289" className="hidden lg:inline-flex w-10 h-10 border border-white/20 items-center justify-center text-white hover:bg-white hover:text-[#0A1931] transition min-h-[40px] min-w-[40px] touch-manipulation">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
            </a>
            {/* Mobile: quick call icon + hamburger */}
            <a href="tel:9136645289" className="lg:hidden w-9 h-9 sm:w-10 sm:h-10 bg-[#C5A253] flex items-center justify-center text-[#0A1931] active:bg-[#B8941F] transition touch-manipulation" aria-label="Call">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"/></svg>
            </a>
            <button
      ...
      <div aria-hidden="true" className="h-[60px] sm:h-[64px] lg:hidden" />
    </>
  );
}
